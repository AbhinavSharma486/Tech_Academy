            ...
            <div className="flex-1 pr-8 max-md:pr-0 max-md:text-center">
              <div className="relative">
                ...
                <h1 className="relative text-4xl font-normal mb-5 text-white leading-tight max-md:text-3xl">
                  Master the <span className="font-bold bg-gradient-to-r from-cyan-400 to-blue-500 bg-clip-text text-transparent drop-shadow-lg">MERN Full Stack Development</span> and build scalable web applications from scratch.
                </h1>
              </div>
              <p className="text-base opacity-90 leading-relaxed backdrop-blur-sm bg-white/5 p-4 rounded-lg border border-white/10">
                Learn MongoDB, Express.js, React, and Node.js through a project-based curriculum crafted by industry experts and IIT alumni.
                Master full stack development, sharpen your Data Structures & Algorithms skills, and gain real-world experience with hands-on projects.
                Prepare for top tech interviews and launch your software career with confidence.
              </p>
            </div>
