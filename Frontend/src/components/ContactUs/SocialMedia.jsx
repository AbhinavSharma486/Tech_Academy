...
const SocialMedia = () => {
  return (
    <div className="bg-white rounded-xl sm:rounded-2xl shadow-lg sm:shadow-xl p-6 sm:p-8 transform hover:scale-[1.02] transition-all duration-300 border border-blue-100">
      <h2 className="text-xl sm:text-2xl font-semibold text-blue-800 mb-4 sm:mb-6 flex items-center">
      ...
      <div className="flex flex-wrap justify-center gap-3 sm:gap-4">
        <a href="#" className="w-10 h-10 sm:w-12 sm:h-12 bg-blue-100 rounded-full flex items-center justify-center hover:bg-blue-200 transition-colors duration-300">
