            ...
            <div className="flex-1 pr-8 max-md:pr-0 max-md:text-center">
              <div className="relative">
                ...
                <h1 className="relative text-4xl font-normal mb-5 text-white leading-tight max-md:text-3xl">
                  Become a Pro in <span className="font-bold bg-gradient-to-r from-cyan-400 to-blue-500 bg-clip-text text-transparent drop-shadow-lg">Data Science & AI</span> and unlock the power of data-driven decision making.
                </h1>
              </div>
              <p className="text-base opacity-90 leading-relaxed backdrop-blur-sm bg-white/5 p-4 rounded-lg border border-white/10">
                Master Data Science, Machine Learning, Deep Learning, and Artificial Intelligence through hands-on projects and expert-led guidance.
                Learn Python, statistics, data visualization, and real-world AI applications to become a job-ready data professional.
              </p>
            </div>
