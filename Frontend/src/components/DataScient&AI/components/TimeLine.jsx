  ...
  content: (
    <div>
      ...
      <p className="mb-6 text-sm font-normal text-black md:text-base">
        Begin with Excel and SQL to explore, clean, and visualize data effectively. Build dashboards and perform EDA using real-world datasets.
      </p>
      <div className="grid grid-cols-2 gap-4 mb-5">
        <img src={image_1} alt="Data Analysis 1" className="w-full rounded-lg object-cover shadow-md md:h-44 lg:h-60" />
        <img src={image_2} alt="Data Analysis 2" className="w-full rounded-lg object-cover shadow-md md:h-44 lg:h-60" />
      </div>
      <RatingCard
        rating={8.4}
        heading="Data Analysis Module"
        comment="A perfect start for beginners in data. The dashboarding and SQL sections were really helpful."
      />
    </div>
  ),
},
{
  ...
  content: (
    <div>
      <p className="text-xl md:text-2xl mb-2">AI & ML Mentorship Support</p>
      <p className="mb-6 text-sm font-normal text-black md:text-base">
        Join weekly mentorship and doubt sessions with AI/ML experts. Get clarity on algorithms, model building, and Python libraries.
      </p>
      <div className="grid grid-cols-2 gap-4 mb-5">
        <img src={image_4} alt="AI Mentorship 1" className="w-full rounded-lg object-cover shadow-md md:h-44 lg:h-60" />
        <img src={image_5} alt="AI Mentorship 2" className="w-full rounded-lg object-cover shadow-md md:h-44 lg:h-60" />
      </div>
      <RatingCard
        rating={9.1}
        heading="AI/ML Mentorship"
        comment="Expert guidance helped me understand complex ML topics and apply them to real datasets."
      />
    </div>
  ),
},
