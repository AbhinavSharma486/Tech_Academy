...
const HeroCard = ({ src, title, des }) => {
  ...
  return (
    <div className="flex items-center justify-center w-screen sm:w-[80vw] md:w-[70vw] max-w-[90vw] lg:max-w-[45vw] xl:max-w-[35vw] h-[30vh] md:h-[35vh] xl:h-[30vh] bg-gray-100 rounded-2xl">
